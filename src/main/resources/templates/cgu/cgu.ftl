...
Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site MatchMoove et leur utilisation par « l'Utilisateur ».
...
MatchMoove se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.

<h2>ARTICLE 2 : Mentions légales</h2>

L'édition du site MatchMoove est assurée par l'équipe de l'école IMIE au capital de 20 0000 € dont le siège social est situé au Immeuble IMIE, 35170 BRUZ.
...
Le site est accessible gratuitement en tout lieu à tout Utilisateur ayant un accès à Internet et un compte de crée par un administrateur. Tous les frais supportés par l'Utilisateur pour accéder au service (matériel informatique, logiciels, connexion Internet, etc.) sont à sa charge.
...
par mail à matchmoove@gmail.com ;
