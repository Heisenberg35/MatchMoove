<<<<<<< HEAD
<input type="hidden" readonly name="items[${index}].id" value="<#if i?? && i.getId()??>${i.getId()}<#else>null</#if>"><br>
...
<input type="text" readonly name="items[${index}].heureDepart" value="<#if i?? && i.getHeureDepart()??>${i.getHeureDepart()}<#else>null</#if>"><br>
=======
